...
| `home/private_dot_config/{btop,htop,git,karabiner}/` | plain tool configs, identical on every Mac (btop/htop rewrite their file on exit — `chezmoi re-add` after changing settings in the UI) |
